...
- [[front | R3-R9]] I recommend to solder all resistors first, as they are the thinest component and thus you can lay the board down with the resistors populated while soldering. I started with 1k&#8486; resistors, but you can choose any order
